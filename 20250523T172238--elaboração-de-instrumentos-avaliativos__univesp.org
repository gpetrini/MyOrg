...
- Vídeo é um encerramento do módulo

** Mapa conceitual

#+begin_src dot :eval no
@startuml Avaliação na Univesp
...
rectangle "Avaliação na Univesp" as central #lightblue



' Tema 3: Perfil do Aluno
rectangle "Perfil do Aluno Univesp" as perfil #peachpuff
central --> perfil

rectangle "Majoritariamente mulheres" as mulheres
rectangle "Idade > 25" as idade
rectangle "Maioria trabalha" as trabalha
rectangle "Renda: 1-3 SM" as SM
rectangle "Maioria casado" as casado
rectangle "Maioria da rede pública" as ensino
rectangle "Maioria pais sem ES" as pais
...
' Tema 5: Funções Intelectuais
rectangle "Funções Intelectuais" as funcoes #lightgreen
central --> funcoes

rectangle "Taxonomia Bloom" as bloom
rectangle "Graus Dificuldade" as graus
rectangle "TRI (ENEM/ENADE)" as tri
funcoes --> bloom
funcoes --> graus
funcoes --> tri

' Tema 6-8: Oficinas
rectangle "Oficinas Avaliativas" as oficinas #lightyellow
central --> oficinas

rectangle "Quiz" as quiz
rectangle "Múltipla Escolha" as multipla
rectangle "Dissertativas" as dissertativas
oficinas --> quiz
oficinas --> multipla
oficinas --> dissertativas


' Tipos de Avaliação
rectangle "Tipos de Avaliação" as tipos #lightcyan
central --> tipos

rectangle "Somativa" as somativa
rectangle "Formativa" as formativa
rectangle "Diagnóstica" as diagnostica
tipos --> somativa
tipos --> formativa
tipos --> diagnostica

' Instrumentos
rectangle "Instrumentos Avaliativos" as instrumentos #peachpuff
central --> instrumentos

rectangle "Provas" as provas
rectangle "Portfólio" as portfolio
rectangle "Observação" as observacao
instrumentos --> provas
instrumentos --> portfolio
instrumentos --> observacao

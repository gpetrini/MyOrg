...
#+FILETAGS: "Agent Based Models" "Upstream-Downstream dynamics" "CATS model family"
...
[cite/t:@assenza_2015_Emergent] enhance the [[id:a80af3a1-8d95-417e-8126-258391e3b79c][CATS ABM family]] by including both a capital and a credit market.
...
- Some small-scale models do not have capital goods modeled
  - This is the case for the first [[id:175002f6-69a8-4fa1-a7da-b76802ecc21e][General Equilibrium Model]]s and [[id:a80af3a1-8d95-417e-8126-258391e3b79c][CATS ABM family]]


** Supporting Ideas and hypothesis


- Labour and capital are homogeneous for simplicity
  - There is no endogenous innovation process as in the [[id:79290780-e39b-4457-a4a6-dfa869f508be][Keynes meets Schumpeter family]]
...
- There is no complete information and there is [[id:b66f2a6b-7daa-4028-ad72-dd20ab5c182c][Transaction Costs]]
  - [[id:b66f2a6b-7daa-4028-ad72-dd20ab5c182c][Transaction Costs]] is included imposing a finite number of interactions among agents
    - Consumption- and capital-goods firms have higher [[id:b66f2a6b-7daa-4028-ad72-dd20ab5c182c][Transaction Costs]] compared to labor market
...
- Household consumption function follows [[id:4a658725-67a6-4a44-b4e1-c74282b52a0e][Permanent Income Hypothesis]]
  - Consumption depends onf human and financial wealth and follows an adaptative algorithm
  - At odds with neoclassical [[id:4a658725-67a6-4a44-b4e1-c74282b52a0e][Permanent Income Hypothesis]], households consider past income insted of expected income
  - Marginal propensity to consume is a non-linear function of wealth as in [[id:d2589b6e-f7b7-4417-90dc-22cd7264dc1b][Carrolls's consumption function]]
...
- The stock of High Powerd Money is constant over time
...
The reason for this step foward is to add realism to the [[id:a80af3a1-8d95-417e-8126-258391e3b79c][CATS ABM family]].

** Contribution

This model adds a stylized supply chain (upstream-downstream dynamics (INSERIR ID)) by including capital- and consumption-goods firms in the [[id:a80af3a1-8d95-417e-8126-258391e3b79c][CATS ABM family]].


** Relevance

This paper is one of the main references for [[id:a80af3a1-8d95-417e-8126-258391e3b79c][CATS ABM family]] which have a capital and credit market.
...
- The interection between Capital and Credit markets with adaptative behavior is the main determinant of GDP volatility and implies endogenous [[id:380b31ad-cdd5-4367-af2c-9ee199a085e7][Business Cycles]] with [[id:67c15aaa-7b6e-4407-b2de-71570ce061f5][Financial Crises]]
...
- It seems unreasonable to assume that firms change prices in a stochastic manner
  - However, when innovation is endogenous, stochastic and affects labor cost (as in [[id:79290780-e39b-4457-a4a6-dfa869f508be][Keynes meets Schumpeter family]]), prices become stochastic as well
...
In this case, the history of capacity utilization ratio will influence the purchace of capital goods in the future.

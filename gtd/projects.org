...
** TODO Conferir e completar referências

*** TODO Incluir Duesenberry

*** TODO Incluir Kydland

*** TODO Referências parágrafos novos seção empírica

*** TODO Remover Goés e Deleidi


** TODO Conferir numeração de figuras

** WAIT Revisão geral e gramarly

** WAIT Formatação

** TODO Incluir equação como mathml

** TODO Conferir formatação das tabelas

** WAIT Estimar modelo com grau de utilização sem log

* PED CE362
:PROPERTIES:
:agenda-group: PED
:END:
** WAIT Divulgar resultado monitoria
** TODO Divuldar lista monopólio

** TODO Resolver lista de monopólio

** WAIT Resolver lista de teoria dos jogos
** WAIT Resolver lista de oligopólio
** WAIT Resolver lista de equilíbrio geral

** WAIT Terminar lista teoria dos jogos
** WAIT Criar lista Equilíbrio Geral

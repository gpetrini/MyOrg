...
- Notas de aula baseadas em Herriges
- Grupos vão aprensentar seminários
  - Regulação
- Oligopólio apresentado antes de teoria dos jogos
  - Modelos aprensentados em termos das curvas de reação
...
O monopolista opera sempre na margem elástica, caso contrário encontraria prejuízos.
Nota-se que bens cujos padrões de consumo são bem estabelecidos, normalmente observa-se uma baixa elasticidade.
...
- Qual deve ser a quantidade ótima?
#+begin_export latex
\begin{align*}
RMg & = \frac{\partial P(Q)Q}{\partial Q}
RT & = (150 - 0.5Q)Q \\
 & = 150 Q - 0.5 Q^2 \\
RMg & = 150 - Q \\
CMg & = 2Q \\
...
- Qual é o preço ótimo?

#+begin_export latex
\begin{align*}
P^\star & = 150 - \frac{1}{2}Q^\star\\
P^\star & = 125
\end{align*}
#+end_export

- Qual é o lucro associado ao ponto ótimo?
#+begin_export latex
\begin{align*}
\Pi^\star_{BAU} & = RT - CT
 & = P^\star Q^\star - (Q^2 + 500) \\
 & = 125 \cdot 50 - (50^2 + 500) \\
 & = 3250
\end{align*}
#+end_export
...
Redução do custo variável em 50%:
#+begin_export latex
\begin{align*}
C_{T,A} & = \frac{Q^2}{2} + 500 \\
\end{align*}
#+end_export
...
|----------+------------+-------+-------|
|----------+------------+-------+-------|
| Cenário  | Quantidade | Preço | Lucro |
|----------+------------+-------+-------|
| BAU      |         50 |   125 |  3250 |
| Corte CV |         75 |       |       |
| Corte CF |            |       |       |
